...
description: Audit and optimize an existing GitHub Copilot Coding Agent configuration against current best practices. Use when a user asks to review, improve, or clean up their Copilot setup, copilot-instructions.md, path-specific instruction files, or setup steps workflow. Also triggers on "check my Copilot config", "is my copilot-instructions.md too long", "tighten Copilot setup", or "my Copilot config feels bloated".
allowed-tools: Read, Write, Edit, Bash, Grep, Glob
argument-hint: "[optional: specific area to focus on, e.g. 'copilot-instructions.md', 'setup-steps']"
---
